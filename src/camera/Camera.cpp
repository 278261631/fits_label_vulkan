...
void Camera::zoom(float delta) {
    m_zoom += delta * m_zoomSensitivity;
...
void Camera::recalculateMatrices() {
    ...
    // 2. 旋转：先绕x轴旋转，再绕y轴旋转，确保z轴向上
    glm::mat4 rotation = glm::rotate(glm::mat4(1.0f), m_rotationX, glm::vec3(1.0f, 0.0f, 0.0f));
    rotation = glm::rotate(rotation, m_rotationY, glm::vec3(0.0f, 1.0f, 0.0f));
